...
document.addEventListener("DOMContentLoaded",()=>{
    ...
    function buildUI(){
      partsBox.innerHTML = ''; // Czyścimy listę części przed przebudową
      palette.innerHTML = ''; // Czyścimy paletę przed przebudową
