...
const MODELS={glock:"g17.svg",sig:"sig.svg",cz:"cz.svg"};
    ...
    /* === INIT === */
    (async()=>{await preloadBGs();buildUI();addModelListeners();defaultBlack();changeBg();})();
...
function chooseModel(model){
  ...
  if(model==="cz"){BG=BG_CZ;TEXTURE="img/cz1.png";}
  else             {BG=BG.filter(p=>!p.startsWith("img/cz"));TEXTURE="img/glock17.png";}
